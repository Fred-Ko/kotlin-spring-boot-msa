...
class UserAddressQueryController(
    private val getUserAddressesQuery: GetUserAddressesUseCase,
    private val getAddressByIdQuery: GetAddressByIdUseCase
) {
    ...
    fun getUserAddresses(
        ...
        val addresses = getUserAddressesQuery.getUserAddresses(query)
