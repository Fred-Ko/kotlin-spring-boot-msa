...
class UserCommandControllerV1(
        ...
        fun register(@Valid @RequestBody request: UserRegisterRequestV1): ResponseEntity<Any> {
                ...
                return if (result.success) {
                        ...
                        ResponseEntity.created(URI.create(profileUri))
                                .body(
                                        mapOf(
                                                "status" to "success",
        ...
        fun login(@Valid @RequestBody request: UserLoginRequestV1): ResponseEntity<Any> {
